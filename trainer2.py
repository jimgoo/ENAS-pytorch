...
class Trainer(object):
    ...
    def __init__(self, args, dataset):
        ...
        self.train_data = utils.batchify_loader(dataset.train, args.batch_size)
        self.valid_data = utils.batchify_loader(dataset.valid, args.batch_size)
        self.eval_data = utils.batchify_loader(dataset.valid, args.test_batch_size)
        self.test_data = None # not used
    ...
    def build_model(self):
        ...
        if self.args.network_type == 'rnn':
            ...
            self.shared = models.Mixed(self.args, self.dataset)
        else:
